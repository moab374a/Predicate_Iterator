...
public class EndsWithTest {
    ...
    public void endsWithEmptyStringShouldAlwaysMatch() {
        String message = "code.EndsWith(<empty string>) should be satisfied by any string!";
    ...
    public void emptyStringCannotEndWithNonEmptyString() {
        String message = "code.EndsWith(<non-empty string>) cannot be satisfied by an empty string!";
    ...
    public void sameStringShouldSatisfy() {
        String message = "code.EndsWith(<some string>) should always be satisfied by the same string!";
    ...
    public void comparisonShouldBeCaseSensitive() {
        String message = "code.EndsWith(<some string>) should compare strings in a case-sensitive manner!";
    ...
    public void charsBeforeSuffixShouldBeIgnored() {
        String message = "code.EndsWith(<some string>) should be satisfied by all strings that end with <some string>!";
    ...
    public void suffixShouldMatchAtLastPosition() {
        String message = "code.EndsWith(<some string>) should only be satisfied if <some string> appears at the strings's very end!";
        assertFalse(message, endsWithJava.test("Java "));
        assertFalse(message, endsWithUML.test("UML "));
    }
}
