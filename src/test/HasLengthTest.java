...
public class HasLengthTest {
    ...
    public void matchEmptyStrings() {
        ...
        String message = "code.HasLength.test(…) should only match strings of the given length (0)!";
    ...
    public void matchNonEmptyStrings() {
        ...
        String message = "code.HasLength.test(…) should only match strings of the given length (5)!";
