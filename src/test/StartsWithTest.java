...
public class StartsWithTest {
    ...
    public void startsWithEmptyStringShouldAlwaysMatch() {
        String message = "code.StartsWith(<empty string>) should be satisfied by any string!";
    ...
    public void emptyStringCannotStartWithNonEmptyString() {
        String message = "code.StartsWith(<non-empty string>) cannot be satisfied by an empty string!";
    ...
    public void sameStringShouldSatisfy() {
        String message = "code.StartsWith(<some string>) should always be satisfied by the same string!";
    ...
    public void comparisonShouldBeCaseSensitive() {
        String message = "code.StartsWith(<some string>) should compare strings in a case-sensitive manner!";
    ...
    public void charsAfterPrefixShouldBeIgnored() {
        String message = "code.StartsWith(<some string>) should be satisfied by all strings that begin with <some string>!";
    ...
    public void prefixShouldMatchAtPositionZero() {
        String message = "code.StartsWith(<some string>) should only be satisfied if <some string> appears at the strings's very beginning!";
        assertFalse(message, startsWithJava.test(" Java"));
        assertFalse(message, startsWithUML.test(" UML"));
    }
}
